...
const en = {
  ...
  "challenge.watch": "Watch this month's sampler",
  "challenge.watchButton": "Watch",
  ...
  "onboarding.intro1Title": "Your tricking dex",
  "onboarding.intro1Body": "Every trick you land unlocks the ones built on top of it. Watch your skill tree open up.",
  "onboarding.intro2Title": "Combos and challenges",
  "onboarding.intro2Body": "Build combos from tricks you land, and take on a fresh challenge every day.",
  "onboarding.tricksTitle": "What do you already land?",
  "onboarding.tricksSubtitle": "Tap the ones you have. You can change these any time.",
  "onboarding.selectAll": "I landed all of these",
  "onboarding.clearAll": "Clear this level",
  "onboarding.selectedCount": "{count} of {total} selected",
  "onboarding.stepOf": "Step {current} of {total}",
  "onboarding.next": "Next",
  "onboarding.back": "Back",
  "onboarding.skip": "Skip",
  "onboarding.finish": "Finish",
  "onboarding.summaryTitle": "You're set up",
  "onboarding.summaryBody": "{count} tricks landed. Your level is {level}.",
  "onboarding.summaryEmpty": "No tricks marked yet — mark them as you go.",
  "onboarding.start": "Start tricking",
  "onboarding.redo": "Set up my tricks",
  "onboarding.unlearnWarning": "This removes {count} tricks you had marked as landed.",
...
const he: Record<TranslationKey, string> = {
  ...
  "profile.addName": "הוסיפו את שמכם",
  ...
  "challenge.monthly": "חודשי",
  "challenge.watch": "צפו בסמפלר של החודש",
  "challenge.watchButton": "צפייה",
  ...
  // Onboarding
  "onboarding.languageTitle": "בחרו שפה",
  "onboarding.nameTitle": "איך לקרוא לכם?",
  "onboarding.namePlaceholder": "השם שלכם",
  "onboarding.intro1Title": "הדקס שלכם",
  "onboarding.intro1Body": "כל טריק שתנחתו פותח את הטריקים שבנויים עליו. תראו את עץ היכולות שלכם נפתח.",
  "onboarding.intro2Title": "קומבואים ואתגרים",
  "onboarding.intro2Body": "בנו קומבואים מהטריקים שאתם נוחתים, וקבלו אתגר חדש כל יום.",
  "onboarding.tricksTitle": "מה אתם כבר נוחתים?",
  "onboarding.tricksSubtitle": "סמנו את מה שיש לכם. אפשר לשנות בכל רגע.",
  "onboarding.selectAll": "נחתי את כל אלה",
  "onboarding.clearAll": "נקו את הרמה",
  "onboarding.selectedCount": "{count} מתוך {total} נבחרו",
  "onboarding.stepOf": "שלב {current} מתוך {total}",
  "onboarding.next": "הבא",
  "onboarding.back": "חזרה",
  "onboarding.skip": "דילוג",
  "onboarding.finish": "סיום",
  "onboarding.summaryTitle": "הכל מוכן",
  "onboarding.summaryBody": "{count} טריקים נחתו. הרמה שלכם היא {level}.",
  "onboarding.summaryEmpty": "עדיין לא סומנו טריקים — סמנו תוך כדי.",
  "onboarding.start": "יאללה לטרק",
  "onboarding.redo": "הגדרת הטריקים שלי",
  "onboarding.unlearnWarning": "הפעולה תסיר {count} טריקים שסימנתם כנחתו.",
