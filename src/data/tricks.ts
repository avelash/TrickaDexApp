...
const TRICKS_DATA_RAW: Trick[] = [
  ...
  },
  {
    ...
    difficulty: 3,
    description:
      "A Btwist in which the rotation comes from an outside crescent (A shuriken).",
  ...
  },
  {
    ...
    difficulty: 2,
    description:
      "Disclaimer: All full variations in the app are for both cart-fulls and back-fulls.\nA backflip during which the practioner does a 180° twist tand then tucks into a frontflip.\nOR\nA 90° turn into a frontflip.(from cartwheel for example)",
  ...
  },
  {
    ...
    difficulty: 2,
    description:
      "A Cheat 720 with two kicks, kick an outside crescent / hook kick during the takeoff and the regular hook kick at the end.",
  ...
  },
  {
    id: "pop540",
    name: "Pop 540",
    icon: require("../../assets/pop540_icon.png"),
    types: ["kick"],
    prerequisites: ["pop_tornado"],
    difficulty: 2,
  ...
  },
  {
    id: "sailor_moon",
    name: "Sailor Moon",
    icon: require("../../assets/sailorMoon_icon.png"),
    types: ["transition", "flip"],
    prerequisites: ["raiz"],
    difficulty: 2,
    description: "A Raiz with a tap on the ground with the leading hand before/during the takeoff",
    tutorialUrl: "https://www.youtube.com/watch?v=V7O5eujw4qs&t=18s",
    takeoff: "front-vanish",
    landingStance: "complete",
  },
  {
    id: "aerial_hook",
    name: "Aerial Hook",
    icon: require("../../assets/aerialHook_icon.png"),
    types: ["flip", "kick", "transition"],
    prerequisites: ["tricker_aerial", "skip_hook"],
    difficulty: 2,
    description: "A Tricker Aerial with a hook kick at the end.",
    tutorialUrl: "https://www.youtube.com/watch?v=-_XLehOuAfo",
    takeoff: "regular",
    landingStance: "hyper",
  },
  {
    id: "envergado",
    name: "Envergado",
    icon: require("../../assets/envergado_icon.png"),
    types: ["flip", "transition"],
    prerequisites: ["raiz",],
    difficulty: 2,
    description: "A Raiz where the practitioner whips both feet together towards the ground.\nOften performed in a D-Leg like shape.",
  ...
  },
  {
    id: "cheat_900",
    name: "Cheat 900",
    icon: require("../../assets/cheat900_icon.png"),
    types: ["kick", "twist"],
    prerequisites: ["cheat_720","backside_900"],
    difficulty: 3,
    description: "From A Cheat takeoff, the practtioner spins (aproximatly) 540° degrees, finishing with a round kick towards the target.",
    tutorialUrl: "https://www.youtube.com/watch?v=_dO9L1n_1Rk",
    takeoff: "back-vanish",
    landingStance: "fake-mega",
  },
  {
    id: "full_twist",
    name: "Full Twist",
    icon: require("../../assets/fullTwist_icon.png"),
    types: ["flip", "twist"],
    prerequisites: ["layout", "arabian"],
    difficulty: 3,
    description: "Disclaimer: All full variations in the app are for both cart-fulls and back-fulls.\n\nA Backflip with a 360° twist.\nOR\nA cart-front with a 180° twist.",
    tutorialUrl: "https://www.youtube.com/watch?v=RZrSNPmVcJE",
    takeoff: "fake-backside",
    landingStance: "complete",
  },
  {
    id: "cork_d-leg",
    name: "Cork D-Leg",
    icon: require("../../assets/corkDleg_icon.png"),
    types: ["flip", "twist"],
    prerequisites: ["cork", "double_leg"],
    difficulty: 3,
  ...
  },
  {
    id: "barani",
    name: "Barani",
    icon: require("../../assets/barani_icon.png"),
    types: ["flip", "twist"],
    prerequisites: ["frontflip"],
    difficulty: 3,
    description: "A frontflip with a 180° twist. Often performed as a no-handed roundoff from two feet.",
    tutorialUrl: "https://www.youtube.com/watch?v=5UHyIfUYmkk",
    takeoff: "frontside",
    landingStance: "backside",
  },
  {
    id: "layout",
    name: "Layout",
    icon: require("../../assets/layout_icon.png"),
    types: ["flip"],
    prerequisites: ["piked_backflip"],
    difficulty: 2,
    description: "A backflip with a straight body shape.",
  ...
  },
  {
    id: "swing_720",
    name: "Swing 720",
    icon: require("../../assets/swing720_icon.png"),
    types: ["kick", "twist"],
    prerequisites: ["swipe", "backside_720"],
    difficulty: 1,
    description: "Similar to a Backside 720 but from a swing setup.",
    tutorialUrl: "https://www.youtube.com/watch?v=NG7urnfNTGI",
    takeoff: "swing",
    landingStance: "hyper",
  },
  {
    id: "swing_900",
    name: "Swing 900",
    icon: require("../../assets/swing900_icon.png"),
    types: ["kick", "twist"],
  ...
  },
  {
    id: "cork_round",
    name: "Cork Round",
    icon: require("../../assets/corkRound_icon.png"),
    types: ["flip", "twist", "kick"],
    prerequisites: ["cork", "tornado_kick"],
    difficulty: 3,
    description: "A Cork with a round kick at the end.\nSimilar to a Swing 900, but with a bit of an inversion.",
  ...
  },
  {
    id: "cork_shuriken",
    name: "Cork Shuriken",
    icon: require("../../assets/corkShuriken_icon.png"),
    types: ["flip", "kick", "twist"],
    prerequisites: ["cork", "backside_720_shuriken"],
    difficulty: 3,
    description: "A Cork in which the rotation comes from an outside crescent (A shuriken).",
    tutorialUrl: "https://www.youtube.com/watch?v=eClOFrcr_pY&t=12s",
    takeoff: "swing",
    landingStance: "complete",
  },
  {
    id: "full_dleg",
    name: "Full D-Leg",
    icon: require("../../assets/fullDleg_icon.png"),
    types: ["flip", "twist"],
    prerequisites: ["full_twist", "double_leg"],
    difficulty: 3,
    description: "A Full Twist with a D-leg shape.",
    tutorialUrl: "https://www.youtube.com/watch?v=Osek673rUNg&t=11s",
    takeoff: "fake-backside",
    landingStance: "complete",
  },
  {
    id: "jesus_backflip",
    name: "Jesus Backflip",
    icon: require("../../assets/jesusBackflip_icon.png"),
    types: ["flip"],
    prerequisites: ["backflip"],
    difficulty: 3,
    description: "A backflip with the arms spread out to the sides(like a T-pose) during the set, delaying rotation."
    + "\nAlso called Stall-Backflip.",
    tutorialUrl: "https://www.youtube.com/watch?v=m9MujeArGig",
    takeoff: "backside",
    landingStance: "backside",
  },
  {
    id: "kick_full",
    name: "Kick Full",
    icon: require("../../assets/kickFull_icon.png"),
    types: ["flip", "kick", "twist"],
    prerequisites: ["full_twist", "flash_kick"],
    difficulty: 4,
    description: "A Flashkick into a full twist.\nAlso called Flash full.",
    tutorialUrl: "https://www.youtube.com/watch?v=kcsdbIrC5xA",
    takeoff: "backside",
    landingStance: "backside",
  },
  {
    id: "backside_720_shuriken",
    name: "Backside 720 Shuriken",
    icon: require("../../assets/backside720Shuriken_icon.png"),
    types: ["kick", "twist"],
    prerequisites: ["backside_720", "pop_360_shuriken"],
    difficulty: 2,
    description: "A Backside 720 with an outside crescent (A shuriken), landing on the kicking leg.",
    tutorialUrl: "https://www.youtube.com/shorts/EqUXlsW3wZk",
    takeoff: "fake-backside",
    landingStance: "fake-mega",
  },
  {
    id: "full_shuriken",
    name: "Full Shuriken",
    icon: require("../../assets/fullShuriken_icon.png"),
    types: ["flip", "twist", "kick"],
    prerequisites: ["full_twist", "backside_720_shuriken"],
    difficulty: 3,
    description: "A Full Twist with an outside crescent (A shuriken).",
    tutorialUrl: "https://www.youtube.com/shorts/EqUXlsW3wZk",
    takeoff: "fake-backside",
    landingStance: "complete",
  }
